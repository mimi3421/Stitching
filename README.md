This version of plugin which is forked form original Imagej/Fuji Grid/Collection stitching plugin exports *zlib* compressed tilted *tif* image as the result to minimize the file size. 
