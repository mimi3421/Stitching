This version of plugin forked form the original Imagej/Fuji Grid/Collection stitching plugin exports *zlib* compressed tilted *tif* image to minimize the file size. 
