This version of plugin which is forked form the original Imagej/Fuji Grid/Collection stitching plugin exports *zlib* compressed tilted *tif* image to minimize the file size. 
